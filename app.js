      ...
      <div class="icon icon-stats">
        <nav-link href="#stats">
          <svg
            ...
            fill="none" stroke="#db2f27" stroke-width="2" stroke-linecap="square"
  ...
  computed: {
    items: function() {
      return Array(+this.total)
        .fill()
        .map((item, i) => ({finished: i < +this.finished, half: i === +this.finished}));
    },
  },
};

const Countdown = {
  props: ['total', 'current', 'stopped', 'paused'],
  template: `
    <div class="timer-container">
      <div class="timer">
        <svg class="arc" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
          <defs>
            <pattern id="diagonal-hatch" patternUnits="userSpaceOnUse" width="4" height="4">
              <path d="M-1,1 l2,-2 M0,4 l4,-4 M3,5 l2,-2" style="stroke:#db2f27; stroke-width:0.5" />
            </pattern>
          </defs>
        ...
        <div class="countdown-container">
          ...
          <div v-if="stopped" class="buttons">
          ...
          <div v-else="" class="buttons">
            ...
            <div v-if="paused" class="btn" v-on:click="$emit('resume')">RESUME</div>
...
const RouteMain = {
  data: function() { return timer; },
  template: `
    <div>
      <toolbar />
      <countdown :total="total" :current="current" :paused="paused" :stopped="stopped"
  ...
  methods: {
    pause: function() { timer.paused = true; stopTimer(); },
    resume: function() { timer.paused = false; startTimer(); },
    stop: function() { timer.stopped = true; stopTimer(true); },
    startWork: function() { timer.stopped = false; startTimer(timer.workDuration); },
    startBreak: function() { timer.stopped = false; startTimer(timer.breakDuration); },
  }
};
